...
class TablePrintable implements Printable {
    ...
    private static final int H_F_SPACE = 5;

    /** Font size for the header text. */
    private static final float HEADER_FONT_SIZE = 13.0f;
    ...
    public int print(Graphics graphics, PageFormat pageFormat, int pageIndex)
        ...
        if (headerText != null) {
            ...
            headerTextSpace = (int) Math.ceil(hRect.getHeight() * (nbLines - 1));
        ...
        if (footerText != null) {
            ...
            footerTextSpace = (int) Math.ceil(fRect.getHeight()+5);
